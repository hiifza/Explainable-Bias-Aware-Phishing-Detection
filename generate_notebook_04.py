...
Usage
-----
    python generate_notebook_04.py
"""
...
cells = [
    ...
    # ── 3. Train/Test Split ────────────────────────────────────────────────────
    md(["## 3. Stratified 80/20 Train/Test Split"], "md_split"),
    ...
    # ── 4. Phase A — TLD Encoding ──────────────────────────────────────────────
    md(["## 4. Phase A — TLD Frequency Encoding"], "md_tld"),
    ...
    # ── 5. Phase B — Skewness correction ──────────────────────────────────────
    md(["## 5. Phase B — Skewness Correction (Log1p)"], "md_log"),
    ...
    # ── 6. Phase C — Outlier Handling ─────────────────────────────────────────
    md(["## 6. Phase C — Outlier Clipping (P99.9)"], "md_clip"),
    ...
    # ── 7. Phase D — Scaling ───────────────────────────────────────────────────
    md(["## 7. Phase D — RobustScaler"], "md_scale"),
    ...
    # ── 8. Phase E — Feature Engineering ──────────────────────────────────────
    md(["## 8. Phase E — Feature Engineering (7 derived features)"], "md_eng"),
    ...
    md(["## 9. Phase F & G — Pipeline Construction & Serialisation"], "md_pipeline"),
    ...
    # ── 10. Phase H — Validation ───────────────────────────────────────────────
    md(["## 10. Phase H — Full Validation"], "md_validate"),
    ...
    md(["## 11. Serialisation Verification"], "md_serial"),
    ...
    # ── 12. Artifact summary ───────────────────────────────────────────────────
    md(["## 12. Artifact Summary"], "md_artifacts"),
...
out = Path(__file__).resolve().parent / "notebooks" / "04_preprocessing.ipynb"
