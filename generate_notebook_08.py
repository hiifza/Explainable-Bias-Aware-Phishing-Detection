"""
generate_notebook_08.py
-----------------------
Run once from project root to emit:
    notebooks/08_lime_analysis.ipynb

Usage
-----
    python generate_notebook_08.py
"""
...
cells = [
    ...
    md(["## 2. Load Model and Data"], "md_load"),
    ...
    md(["## 3. Compute SHAP Values (for comparison)"], "md_shap"),
    ...
    md(["## 4. Initialize LIME Explainer"], "md_lime_init"),
    ...
    md(["## 5. Generate TP / TN / FP / FN LIME Explanations"], "md_local"),
    ...
    md(["## 6. SHAP vs LIME Agreement Analysis"], "md_agreement"),
    ...
    md(["## 7. Agreement Table & High-Disagreement Cases"], "md_disagree"),
    ...
    md(["## 8. Feature Consistency"], "md_consist"),
    ...
    md(["## 9. Export HTML Report and Verify Artifacts"], "md_report"),
    ...
    md(["## 10. Downstream Interface"], "md_interface"),
...
out = Path(__file__).resolve().parent / "notebooks" / "08_lime_analysis.ipynb"
